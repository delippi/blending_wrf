...
!=======================================================================
  ...
  real    :: sdmd,slmd,ppb,ttb,albn,aln,qvf1,qv1,qv1_b,qv2,qv2_b
  real    :: t_full,rho_full,PH_full,PH_hd,ptop


  real, dimension(ml,nl,kk1-1) :: qw,qvapor,t,tw
  real, dimension(ml,nl,kk1)   :: PH1,PHB,PH
  real, dimension(ml,nl) :: MU1,psw,MUB_2d,HGT_2d
  real, dimension(kk1-1) :: DNW_1d,ZNU_1d,RDNW_1d,RDN_1d
  real, dimension(ml,nl,kk1-1) :: TP,Brho,PP,PPA
  real, dimension(ml,nl) :: MU2,MU_2d

  real, parameter    :: tis0=290.     ! Value used in WRF.
  real, parameter    :: ts0=300.      ! Value used in WRF.
  real, parameter    :: ps0=100000.   ! Value used in WRF.
!!  real, parameter    :: ptop=3000.    ! Value used in WRF.
  real, parameter    :: tlp=50.       ! Value used in WRF.
  ...
  real, parameter    :: cvpm = -(1.-gas_constant / cp)
  real, parameter    :: cpovcv = cp/(cp-gas_constant)
